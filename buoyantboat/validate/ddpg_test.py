...
# model_path = os.path.abspath("./boat_heave_comp_PPO_policy_new.zip")
# model_path = os.path.abspath("./good_models/working_no_winch/DDPG_ALL_STATES_vel_pos_rewards/best_model.zip")
...
df.to_csv("states_ddpg_no_winch.csv", index=False)
plt.legend()
plt.tight_layout()
plt.show()
